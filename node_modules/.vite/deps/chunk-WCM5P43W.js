...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime7.jsxs)(React23.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime7.jsxs)(React23.Fragment, {
  ...
  const Grid2 = React26.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React26.Children.map(children, (child) => {
        if (React26.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WCM5P43W.js.map
